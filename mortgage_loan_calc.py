#!/usr/bin/env python3
# -*- coding: utf-8 -*-
''' mortgage_loan_calc.py

Calculate the monthly payment on a mortgage loan

For mortgage payments use this formula:
# monthly interest rate given % annual interest rate
...
def calc_mortgage(principal, interest, years):
    '''
    given mortgage loan principal, annual interest(%) and years to pay
