...
Create a '3 Pac-Man triangle' optical illusion using three arcs
...
see also:
https://tkdocs.com/shipman/create_arc.html
...
root = tk.Tk()
# give it a title
root.title("3 Pac-Man triangle")

# create a canvas to draw on
cv = tk.Canvas(root, width=300, height=340, bg='white')
cv.pack()
