#!/usr/bin/env python3
# -*- coding: utf-8 -*-
''' Solvents_csv_to_list_of_lists.py

Create a list of lists from a Comma Separated Value (csv) file

tested with Spyder IDE on LinuxMint  vegaseat 19jul2026
'''

# common solvent raw_data string is from a csv file ...
# created and applied by 'vegas-eat' around 1993
raw_data = """\
...
# build a 'list of lists' data_list
data_list = []
...
import pprint
pprint.pprint(data_list, indent=0)
