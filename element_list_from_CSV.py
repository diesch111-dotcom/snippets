#!/usr/bin/env python3
# -*- coding: utf-8 -*-
""" element_list_from_CSV.py

given a CSV file of elements convert this data into a list
ideally into a list of lists that follow the header
...
tested using LinuxMint and Spyder IDE  dns(vegaseat)  4jul2026
"""
...
#print(element_csv.split('\n'))  # works!!

# this creates a list where each line is a string
element_list2 = element_csv.split('\n')

# testing...
print(len(element_list2), len(element_header))
print(element_list2)
print("="*40)

element_list3 = []
for item in element_list2:
    #a_num, symb, name, a_weight = item.split(",")
    print(item.split(','))

element_list3 = [item.split(",") for item in element_csv.split('\n')]

# testing...
print(element_list3)
print("="*40)

pprint.pprint(element_list3, width=60, compact=True)

""" modified result for copy/paste...
