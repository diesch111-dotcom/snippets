...
to change width of column drag boundary
    ...
    def _build_tree(self):
        ...
        for item in element_list2:
            self.tree.insert('', 'end', values=item.split(","))

            # adjust column's width if necessary to fit each value
            for ix, val in enumerate(item.split(",")):
...
# notice this is a liSt of strings. need to split at comma
element_list2 = \
['1,H,Hydrogen,1.008',
 ...
 '7,N,Nitrogen,14.007',
 '8,O,Oxygen,15.999',
 '9,F,Fluorine,18.99840',
 '10,Ne,Neon,20.1797',
 '11,Na,Sodium,22.9897692',
 '12,Mg,Magnesium,24.305',
 '13,Al,Aluminium,26.98153',
