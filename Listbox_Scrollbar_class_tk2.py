#!/usr/bin/env python3
# -*- coding: utf-8 -*-
''' Listbox_Scrollbar_class_tk2.py

A ScrolledListbox class for general application,
has vertical and horizontal scrollbars showing on demand.
...
itemslist = [
'Stew', 'Tom', 'Jen', 'Adam', 'Ethel', 'Barb', 'Tony', 'Astrahim',
'and now an extended string to trigger the horizontal scrolling',
'Pavel', 'Pete', 'Sally', 'Egon', 'Fuzzy', 'Swen', 'Albert', 'Zoey',
